...
export const debtorsColumns = (pageNumber, pageSize, openInvoiceDetailsModal, downloadInvoice, permissions, openCompanyDetailsModal) => [
    {
        title: `#`,
        key: 'numberOfRow',
        fixed: 'left',
        ...
        render: (row) => {
            return (
                <div className='flex justify-center'>
                    ...
                    {
                        Authorize(permissions, [PERMISSIONS.INVOICE.EXPORT]) ? (
                          <Tooltip title={'PDF'}>
                    ...
                    {
                        Authorize(permissions, [PERMISSIONS.INVOICE.EXPORT]) && row?.reportDesignVersion === 'V1' ? (
                          <Tooltip title={'Excel'}>
                    ...
                    {
                        Authorize(permissions, [PERMISSIONS.INVOICE.EXPORT]) && row?.reportDesignVersion === 'V2' ? (
