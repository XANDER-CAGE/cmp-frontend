...
export const stationChainsCompanyDiscountsColumns = (pageNumber, pageSize, deleteCompanyDiscount, deleteLoading, openModal) => [
    {
        title: `#`,
        key: 'numberOfRow',
        fixed: 'left',
    ...
    {
        title: `Total Discounts Count`,
        dataIndex: 'totalDiscountsCount',
        key: 'totalDiscountsCount',
        type: 'string',
        align: 'center',
        width: 200,
        checked: true,
