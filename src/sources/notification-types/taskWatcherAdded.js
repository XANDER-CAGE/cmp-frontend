        ...
        >
            <div className='flex items-center justify-between'>
                <div className='flex items-center'>
                    <div className='w-[32px] h-[32px] bg-[#5714a7] text-[white] rounded-full flex items-center justify-center'>{item?.AddedByUsername?.slice(0, 1)}</div>
                    <span className='ml-2'><b>{item?.AddedByUsername}</b> added: </span>
                    <Tag
                        color={"gold"}
                        className='ml-3'
                    >
                        {item?.WatcherUsername}
                    </Tag>
                </div>
...
export default TaskWatcherAdded