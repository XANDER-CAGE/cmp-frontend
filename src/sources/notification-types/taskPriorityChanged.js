...
const TaskPriorityChanged = (props) => {
        ...
        >
            <div className='flex items-center justify-between'>
                <div className='flex items-center'>
                    ...
                    <span className='ml-2'><b>{item?.ChangedByUsername}</b> changed Priority to:</span>
                    <Tag
                        color={setTagColor(item?.NewPriority)}
                        className='ml-3'
                    >
                        {item?.NewPriority}
                    </Tag>
...
export default TaskPriorityChanged