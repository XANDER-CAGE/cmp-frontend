        ...
        >
            <div className='flex items-center justify-between'>
                <div className='flex items-center'>
                    <div className='w-[32px] h-[32px] bg-[#5714a7] text-[white] rounded-full flex items-center justify-center'>{item?.ReassignedByUsername?.slice(0, 1)}</div>
                    <span className='ml-2'><b>{item?.ReassignedByUsername}</b> reassigned to:</span>
                    <Tag
                        color={"red"}
                        className='ml-3'
                    >
                        {item?.NewAssignedByUsername}
                    </Tag>
                </div>
