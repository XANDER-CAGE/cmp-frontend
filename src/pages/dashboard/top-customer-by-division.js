...
const TopCustomersByDivision = (props) => {
    ...
    const options = useMemo(() => {
        return {
            title: {
                text: "Top Customers By Discount Division",
                align: 'center',
                floating: false,
                style: {
                    fontSize: '16px',
    ...
    const getDashboardInfo = async () => {
        setIsLoading(true)
        try {
            const response = await http.post(`dashboard/Chart/TopCustomersByDiscountDivision`, filters)
...
export default TopCustomersByDivision