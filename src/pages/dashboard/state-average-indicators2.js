...
import map from "@amcharts/amcharts5-geodata/usaLow"

const StateAverageIndicators2 = () => {
    useEffect(() => {
    ...
    return (
        <div id='chartdiv' className='w-[100%] h-[60vh]'></div>
    )
}

export default StateAverageIndicators2