...
import StateAverageIndicators from './types/state-average-indicators'

const { RangePicker } = DatePicker

const StateAverageIndicatorsDashboard = () => {
    const [organizations, setOrganizations] = useState([])
    const [organizationId, setOrganizationId] = useLocalStorageState("state-average-indicators-organizationId", { defaultValue: null })
    const [efsAccounts, setEfsAccounts] = useState([])
    const [efsAccountId, setEfsAccountId] = useLocalStorageState("state-average-indicators-efsAccountId", { defaultValue: null })
...
export default StateAverageIndicatorsDashboard