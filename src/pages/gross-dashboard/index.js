...
import Gross from './types/gross'
import AvarageDiscountPerGallon from './types/avarage-discount-per-gallon'
import RevenueBar from './types/revenue-bar'
import RevenuePie from './types/revenue-pie'

const { RangePicker } = DatePicker

const GrossDashboard = () => {
    const [organizations, setOrganizations] = useState([])
    const [organizationId, setOrganizationId] = useLocalStorageState("gross-organizationId", { defaultValue: null })
    const [efsAccounts, setEfsAccounts] = useState([])
    const [efsAccountId, setEfsAccountId] = useLocalStorageState("gross-efsAccountId", { defaultValue: null })
