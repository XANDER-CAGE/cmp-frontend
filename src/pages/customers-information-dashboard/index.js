...
import TopCustomersByGross from './types/top-customers-by-gross'
import NumberOfCustomers from './types/number-of-customers'
import CompanyInformation from './types/company-information'

const { RangePicker } = DatePicker

const CustomersInformationDashboard = () => {
    const [organizations, setOrganizations] = useState([])
    const [organizationId, setOrganizationId] = useLocalStorageState("customers-info-organizationId", { defaultValue: null })
    const [efsAccounts, setEfsAccounts] = useState([])
    const [efsAccountId, setEfsAccountId] = useLocalStorageState("customers-info-efsAccountId", { defaultValue: null })
...
export default CustomersInformationDashboard