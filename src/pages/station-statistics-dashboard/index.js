...
import StationStatistics from './types/station-statistics'
import StationStatisticsByGross from './types/station-statistics-gross'

const { RangePicker } = DatePicker

const StationStatisticsDashboard = () => {
    const [organizations, setOrganizations] = useState([])
    const [organizationId, setOrganizationId] = useLocalStorageState("station-statistics-organizationId", { defaultValue: null })
    const [efsAccounts, setEfsAccounts] = useState([])
    const [efsAccountId, setEfsAccountId] = useLocalStorageState("station-statistics-efsAccountId", { defaultValue: null })
...
export default StationStatisticsDashboard